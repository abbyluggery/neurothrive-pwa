...
async function syncData() {
  // In a real app, this would sync local data to server
  console.log('Syncing data when connection restored');
}

// Push notifications
self.addEventListener('push', event => {
  const options = {
    body: event.data ? event.data.text() : 'Time for your routine!',
